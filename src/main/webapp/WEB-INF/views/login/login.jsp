            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <form class="form" action="/users" method="post">
                    ...
                    <div class="inputForm">
                        ...
                        <input type="text" class="input" name="login-email" placeholder="Enter your Email">
                    </div>
                    ...
                    <div class="inputForm">
                        ...
                        <input type="password" class="input" name="login-password" placeholder="Enter your Password">
                    ...
                    <p class="p">Don't have an account? <a href="/users/register" style="text-decoration: none"><span
	...
	C318.115,0,375.068,22.126,419.404,58.936z"></path>
                        ...
                        <button class="btn apple">
                            <svg version="1.1" height="20" width="20" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 style="enable-background:new 0 0 22.773 22.773;" xml:space="preserve"> <g>
                                <g>
